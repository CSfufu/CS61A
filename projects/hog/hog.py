...
"""However, you only have to make changes to hog.py"""
...
def swine_align(player_score, opponent_score):
    ...
    if player_score==0 or opponent_score==0:
        return False
    elif return_gcd(player_score,opponent_score)>=10:
        return True
    else:
        return False
    # END PROBLEM 4a
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who == 0:
            ...
            say = say(score0,score1)
        #print("DEBUG",not extra_turn(score0,score1))
        if who ==0 and not extra_turn(score0,score1):
            who = 1
            #print("DEBUG",who)
            #print("DEBUG",score0)
            #print("DEBUG",score1)
        elif who ==1 and not extra_turn(score1,score0):
            who = 0
            #print("DEBUG",who)
            #print("DEBUG",score0)
            #print("DEBUG",score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    #def say(score0,score1):
    def say(*score):
        assert len(score)==2,'input two players'
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_dice = 10
    while max_dice >=1:
        rows = make_averaged(roll_dice,trials_count)(max_dice,dice)
        if rows > max_rows:
            max_rows = rows
            max_turn = max_dice
        max_dice-=1
