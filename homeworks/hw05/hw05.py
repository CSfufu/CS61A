class VendingMachine:
    ...
    def __init__(self, product_name, product_price):
        ...
        self.stock = 0
    def vend(self):
        if self.inventory == 0 and self.stock == 0:
            return 'Inventory empty. Restocking required.'
        elif self.stock != 0:
            if self.inventory < self.price:
                return 'You must add ${0} more funds.'.format(self.price - self.inventory)
    ...
    def add_funds(self, amount):
        if self.inventory == 0 and self.stock == 0:
            ...
            return 'Current balance: ${0}'.format(self.inventory)
...
def store_digits(n):
    ...
    def helper(n):
        ...
        if n < 10:
            ...
            i -= 1
            return Link(digit, store_digits(n-digit*int(pow(10, i))))
    return helper(n)
def is_bst(t):
